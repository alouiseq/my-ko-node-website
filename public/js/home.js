$(document).ready(function(){
  ...
  $("img:not('#me')").hover(function(){
    $(this).parent("div.col-left").stop().find("img").stop().animate({width:'250px', height:'250px'}, 1000);
  }, function(){
  ...
  $("a").hover(function(){
    $(this).parent("div").find("img").stop().animate({width:'250px', height:'250px'}, 1000);
  }, function(){
    $(this).parent("div").find("img").stop().animate({width:'200px', height:'200px'}, 1000);
  });

  // animate right columns
  $("a").hover(function(){
    $(this).parent("div").find("img").stop().animate({width:'250px', height:'250px'}, 1000);
  }, function(){
    $(this).parent("div").find("img").stop().animate({width:'200px', height:'200px'}, 1000);
